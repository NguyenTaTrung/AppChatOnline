...
public class ShowImageActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img = findViewById(R.id.circleImg);
        name = findViewById(R.id.name);

        Intent intent = getIntent();
        Picasso.with(this).load(intent.getStringExtra("imgurl")).into(imageView);
        Picasso.with(this).load(intent.getStringExtra("img")).into(img);
